...
// Remove this reference if you enter the connection string directly
#include "secret.h"
...
//
// Note: this connection string is specific to the device "virtual-coffee-machine". To configure other devices,
